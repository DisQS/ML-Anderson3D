...
def create_CNN():
    ...
    model.add(Conv2D(16, kernel_size=(5,5),input_shape=(img_sizeX, img_sizeY, 4),
...
#Confusion Matrix 
Y_pred = model.predict_generator(validation_set, num_of_valid_samples // batch_size+1, verbose=1)
